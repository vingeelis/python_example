...
class User(AbstractUser):
    ...
    birthday = models.CharField(max_length=20, default='1997-10-31')  # 生日
    ...
    zhengzhi_time = models.CharField(max_length=20, default='2010-10-31')  # 入党、团时间

    job = models.CharField(max_length=30, default='工程师')  # 职称
    job_time = models.CharField(max_length=20, default='2010-10-31')  # 获得职称时间

    job_2 = models.CharField(max_length=30, default='员工')  # 职务
    id_number = models.CharField(max_length=30, default='110108199901216982')  # 身份证
